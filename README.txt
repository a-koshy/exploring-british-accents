...
This folder contains the data, R code and supplemental outputs accompanying the paper 'Exploring British Accents: Modeling the Trap–Bath Split with Functional Data Analysis' by Aranya Koshy and Dr Shahin Tavakoli.


1. DATA
-------
Datasets are stored in /data/. The original NSCV audio files can be obtained from http://wrap.warwick.ac.uk/138368/. The entire BNC audio edition can be accessed at http://www.phon.ox.ac.uk/AudioBNC, and the subset of ``class'' words analyzed in this paper are in bnc_sounds.rda. Preprocessed datasets of the NSCV and BNC formants and MFCCs are provided here, and can be recreated from the original audio by running preprocessing.R.
